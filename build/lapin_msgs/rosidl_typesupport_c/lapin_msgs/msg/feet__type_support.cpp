...
static const _Feet_type_support_symbol_names_t _Feet_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lapin_msgs, msg, Feet)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lapin_msgs, msg, Feet)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lapin_msgs, msg, Feet)() {
  return &::lapin_msgs::msg::rosidl_typesupport_c::Feet_message_type_support_handle;
}
